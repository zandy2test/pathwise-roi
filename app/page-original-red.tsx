      ...
      {mode === 'intro' && (
        <section className="text-center py-16 space-y-8 bg-gradient-to-br from-red-50 via-white to-yellow-50">
          ...
          <div className="flex justify-center mb-8">
            <AnimatedGradientText className="bg-red-600 text-white px-6 py-3 rounded-xl">
              <span>
                <span className="text-sm font-semibold">🚨 US STUDENT DEBT CRISIS</span>
                <span className="mx-2">•</span>
                <span className="text-lg font-black">$1.7 TRILLION</span>
                <span className="mx-2">•</span>
                <span className="text-sm opacity-90">Growing by $3,000/second</span>
              </span>
            </AnimatedGradientText>
          </div>

          <AnimatedGradientHeading className="text-6xl font-black tracking-tight leading-tight">
            The $200,000 Question: Is College Worth It?
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto py-8">
            <div className="bg-red-100 border-l-4 border-red-500 p-4 rounded-r-lg">
              <div className="text-3xl font-black text-red-700">
                <NumberTicker value={73} suffix="%" delay={0.2} />
              </div>
            ...
            <div className="bg-yellow-100 border-l-4 border-yellow-500 p-4 rounded-r-lg">
              <div className="text-3xl font-black text-yellow-700">
                <NumberTicker value={42} suffix="%" delay={0.4} />
              </div>
            ...
            <div className="bg-green-100 border-l-4 border-green-500 p-4 rounded-r-lg">
              <div className="text-3xl font-black text-green-700">
                <NumberTicker value={96} suffix="%" delay={0.6} />
              </div>
