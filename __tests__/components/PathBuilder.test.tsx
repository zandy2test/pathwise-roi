...
describe('PathBuilder Component', () => {
  ...
  describe('Scholarships Input', () => {
    ...
    it('should display maximum scholarship amount hint', () => {
      render(
        <PathBuilder 
          inputs={defaultInputs} 
          setInputs={mockSetInputs} 
      ...
      expect(screen.getByText('Maximum: $100,000')).toBeInTheDocument()
    })
  })
